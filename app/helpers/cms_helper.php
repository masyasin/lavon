...
function cms_module_config($module_directory, $key, $value = NULL, $delete = FALSE){
    $main_config_file_name = APPPATH.'modules/'.$module_directory.'/config/module_config.php';
    ...
    if(defined('CMS_SUBSITE') && CMS_SUBSITE != ''){
        $file_name = APPPATH.'modules/'.$module_directory.'/config/module_config_'.CMS_SUBSITE.'.php';
