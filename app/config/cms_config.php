...
$config['site_theme'] = 'metronic';

$config['cms_google_analytic_property_id'] = '';

$config['site_favicon'] = '{{ base_url }}public/assets/themes/favicon/favicon.png';
$config['site_footer'] = 'Sintech Berkah Abadi © 2018';
$config['site_logo'] = '{{ base_url }}public/assets/themes/favicon/favicon.png';
$config['site_name'] = 'Lavon';
$config['site_slogan'] = 'Lavon ';
$config['site_layout'] = 'default';
$config['cms_email_reply_address'] = 'no-reply@Lavon.net';
$config['cms_email_forgot_subject'] = 'Re-activate your account at Lavon';
