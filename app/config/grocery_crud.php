<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	//For view all the languages go to the folder public/assets/gc/languages/
	...
	$config['grocery_crud_default_per_page']	= 100000;
	...
	$config['grocery_crud_paging_options'] = array('10','25','50','100','200','300','500','1000');
