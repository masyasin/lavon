...
<h1 class="page-title"> Transaksi Tenan
    <small>bill transaksi tenan</small>
</h1>
            ...
            <div class="row">
                ...
                <div class="col-md-12" v-show="has_valid_unit">
                    ...
                    <div class="col-md-12 text-center">
                            ...
                            <button :disabled="unit.already_checkin|| unit.card_number==''||fasilitas_terpilih.length==0" type="button" class="btn btn-success  margin-left-1em bold" @click="doCheckIn(unit.id)">Simpan</button>
