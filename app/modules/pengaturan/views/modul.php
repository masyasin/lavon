<h1 class="page-title"> Pengaturan Modul
    <small>inputs add, edit and delete modul data</small>
</h1>
<div class="row">        
    <div class="col-md-12">
...
<div style="clear:both; margin: 5px;">
    <form action="<?php echo site_url('pengaturan/modul');?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
