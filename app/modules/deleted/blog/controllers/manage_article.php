...
class Manage_Article extends CMS_Priv_Strict_Controller {
    ...
    public function index(){
        ...
        $crud->columns('article_title','allow_comment','categories','photos','comments');
        ...
        $crud->display_as('article_title','Judul');
        ...
        $crud->display_as('allow_comment','Izinkan Komentar');
        $crud->display_as('categories','Kategori');
        $crud->display_as('photos','Gambar');
        ...
        $output = $crud->render();
         $view_config = array(
           ...
           // $this->cms_complete_navigation_name('manage_article'),$view_config);
    ...
    public function after_insert_or_update($post_array, $primary_key){
        ...
        foreach($insert_records as $insert_record){
            ...
            $upload_path = APPPATH.'modules/'.$this->cms_module_path().'/assets/uploads/';
