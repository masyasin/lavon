...
<div class="container animsition">
  ...
  <div class="col-md-9 col-no-gutter" id="glist">
    ...
    <article class="headline-news-single withsubtitle">
      <header>
        <h1 class="title">{{gv.judul}}</h1>
      </header>
      <figure class="hero">
        <div class="videoWrapper">
    
         <iframe width="560" height="349" frameborder="0" v-bind:src="gv.yt_embed_url" style="width: 100%" allowfullscreen></iframe></div>
        <figcaption>
        <b>{{gv.judul}}</b><br>{{gv.keterangan}}
