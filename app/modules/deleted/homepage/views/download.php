  ...
  <div class="col-md-9 col-no-gutter">
    <article class="headline-news-single withsubtitle">
      ...
      <div class="content-text-editor">
        <p>Berikut ini adalah beberapa daftar file download yang dapat anda unduh :</p>
        <div data-role="content">  
            <ul class="list-icons white-bg lsr" >
              <?foreach($download as $d):?>
              <li>
              <a class="l-item"  href="{{ base_url }}konten/download/<?=my_simple_crypt($d['id'],'e').'/'.slugify($d['judul'])?>"><i class="icon wb-user" aria-hidden="true"></i> <?=$d['judul']?></a>
              </li>
              <?endforeach?>
            </ul>
          </div>
