      ...
      <div class="panel">
        ...
        <header class="panel-heading">
          ...
          <h3 class="panel-title">
            <input class="form-control input-sm" type="text" name="article_title" placeholder="Judul Artikel" value=""><br>
        ...
        <textarea class="hidden" name="content" id="textarea-content">
		  ...
		  <hr>
			...
			<?php } ?>
				<button class="cancel-button button btn btn-danger"><i class="fa fa-times"></i> Batal</button>
        </div>
