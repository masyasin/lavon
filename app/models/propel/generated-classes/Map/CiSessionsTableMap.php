...
class CiSessionsTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CiSessionsTableMap::COL_SESSION_ID, CiSessionsTableMap::COL_IP_ADDRESS, CiSessionsTableMap::COL_USER_AGENT, CiSessionsTableMap::COL_LAST_ACTIVITY, CiSessionsTableMap::COL_USER_DATA, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CiSessionsTableMap::COL_SESSION_ID => 0, CiSessionsTableMap::COL_IP_ADDRESS => 1, CiSessionsTableMap::COL_USER_AGENT => 2, CiSessionsTableMap::COL_LAST_ACTIVITY => 3, CiSessionsTableMap::COL_USER_DATA => 4, ),
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('session_id', 'SessionId', 'VARCHAR', true, 50, null);
        $this->addColumn('ip_address', 'IpAddress', 'VARCHAR', true, 16, null);
        $this->addColumn('user_agent', 'UserAgent', 'VARCHAR', true, 120, null);
        $this->addColumn('last_activity', 'LastActivity', 'INTEGER', true, 20, null);
        $this->addColumn('user_data', 'UserData', 'LONGVARCHAR', false, null, null);
    } // initialize()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CiSessionsTableMap::COL_SESSION_ID);
            $criteria->addSelectColumn(CiSessionsTableMap::COL_IP_ADDRESS);
            $criteria->addSelectColumn(CiSessionsTableMap::COL_USER_AGENT);
            $criteria->addSelectColumn(CiSessionsTableMap::COL_LAST_ACTIVITY);
            $criteria->addSelectColumn(CiSessionsTableMap::COL_USER_DATA);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CiSessionsTableMap::COL_SESSION_ID, (array) $values, Criteria::IN);
        }
