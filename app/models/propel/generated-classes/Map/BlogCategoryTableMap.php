...
/**
 * This class defines the structure of the 'blog_category' table.
 *
 *
 *
...
class BlogCategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.BlogCategoryTableMap';
     ...
     */
    const OM_CLASS = '\\BlogCategory';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'BlogCategory';
     ...
     */
    const COL_CATEGORY_ID = 'blog_category.category_id';

    /**
     * the column name for the category_name field
     */
    const COL_CATEGORY_NAME = 'blog_category.category_name';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'blog_category.description';

    /**
     * the column name for the invalid field
     */
    const COL_INVALID = 'blog_category.invalid';

    /**
     * the column name for the rplc field
     */
    const COL_RPLC = 'blog_category.rplc';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('CategoryId', 'CategoryName', 'Description', 'Invalid', 'Rplc', ),
        self::TYPE_CAMELNAME     => array('categoryId', 'categoryName', 'description', 'invalid', 'rplc', ),
        self::TYPE_COLNAME       => array(BlogCategoryTableMap::COL_CATEGORY_ID, BlogCategoryTableMap::COL_CATEGORY_NAME, BlogCategoryTableMap::COL_DESCRIPTION, BlogCategoryTableMap::COL_INVALID, BlogCategoryTableMap::COL_RPLC, ),
        self::TYPE_FIELDNAME     => array('category_id', 'category_name', 'description', 'invalid', 'rplc', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('CategoryId' => 0, 'CategoryName' => 1, 'Description' => 2, 'Invalid' => 3, 'Rplc' => 4, ),
        self::TYPE_CAMELNAME     => array('categoryId' => 0, 'categoryName' => 1, 'description' => 2, 'invalid' => 3, 'rplc' => 4, ),
        self::TYPE_COLNAME       => array(BlogCategoryTableMap::COL_CATEGORY_ID => 0, BlogCategoryTableMap::COL_CATEGORY_NAME => 1, BlogCategoryTableMap::COL_DESCRIPTION => 2, BlogCategoryTableMap::COL_INVALID => 3, BlogCategoryTableMap::COL_RPLC => 4, ),
        self::TYPE_FIELDNAME     => array('category_id' => 0, 'category_name' => 1, 'description' => 2, 'invalid' => 3, 'rplc' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        // attributes
        $this->setName('blog_category');
        $this->setPhpName('BlogCategory');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\BlogCategory');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('category_id', 'CategoryId', 'INTEGER', true, 20, null);
        $this->addColumn('category_name', 'CategoryName', 'VARCHAR', false, 50, null);
        $this->addColumn('description', 'Description', 'LONGVARCHAR', false, null, null);
        $this->addColumn('invalid', 'Invalid', 'INTEGER', false, null, 0);
        $this->addColumn('rplc', 'Rplc', 'INTEGER', false, null, null);
    } // initialize()
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to blog_category     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BlogCategoryTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(BlogCategoryTableMap::COL_INVALID);
            $criteria->addSelectColumn(BlogCategoryTableMap::COL_RPLC);
        } else {
            $criteria->addSelectColumn($alias . '.category_id');
            $criteria->addSelectColumn($alias . '.category_name');
            $criteria->addSelectColumn($alias . '.description');
            $criteria->addSelectColumn($alias . '.invalid');
            $criteria->addSelectColumn($alias . '.rplc');
        }
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(BlogCategoryTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(BlogCategoryTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new BlogCategoryTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \BlogCategory) { // it's a model object
...
//
BlogCategoryTableMap::buildTableMap();
